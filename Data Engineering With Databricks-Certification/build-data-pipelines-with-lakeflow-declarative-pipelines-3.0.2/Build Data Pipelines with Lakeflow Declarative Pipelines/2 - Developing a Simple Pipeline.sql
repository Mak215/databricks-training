...
-- MAGIC
-- MAGIC     - **Pipeline root folder**: Select the **2 - Developing a Simple DLT Pipeline Project** folder (`/Workspace/Users/your-lab-user-name/build-data-pipelines-with-lakeflow-declarative-pipelines-3.0.0/Build Data Pipelines with Lakeflow Declarative Pipelines/2 - Developing a Simple DLT Pipeline Project`)
-- MAGIC
-- MAGIC     - **Source code paths**: Within the same root folder as above, select the **orders** folder (`/Workspace/Users/your-lab-user-name/build-data-pipelines-with-lakeflow-declarative-pipelines-3.0.0/Build Data Pipelines with Lakeflow Declarative Pipelines/2 - Developing a Simple DLT Pipeline Project/orders`)
-- MAGIC
